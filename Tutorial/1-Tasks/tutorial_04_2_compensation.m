...
designEvaluatorNormal = DesignEvaluatorBottomUpMapping(bottomUpMapping,...
...
%% Compensation
%TODO: setup the compensation evaluator
% definition: designEvaluatorCompensation,aspaceLowerBound,aspaceUpperBound,aspaceInitialDesign 
