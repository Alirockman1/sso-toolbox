function trimmedCandidateSpace = component_trimming_operation_policy(designSample,labelViable,trimmingOrder,componentIndex,candidateSpace,varargin)
...
%   limitations under the License.
    ...
    for i=1:size(componentIndex,2)
        ...
        trimmedCandidateSpace(i) = candidateSpace(i).update_candidate_space(designSampleComponent,trimmingInformation);
    end
end