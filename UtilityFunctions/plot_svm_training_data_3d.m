function plotHandle = plot_svm_training_data_3d(graphicsHandle,svm,options)
...
%
%   PLOT_SVM_TRAINING_DATA_3D(GRAPHICSHANDLE,SVM) plots in GRAPHICSHANDLE
...
%
%   PLOT_SVM_TRAINING_DATA_3D(GRAPHICSHANDLE,SVM,OPTIONS) allows for setting
