function performanceMeasure = truss_six_bar_2d_two_moving_node(designSample,systemParameter)
...
%   limitations under the License.
	...
	nodePosition = [0 0; nan nan; 2 0.5; nan nan; 0 1]; % assumed [mm]
	fixedDegreesOfFreedom = [true true; false false; false false; false false; true true];
	nodeForce = [0 0; 0 0; 0 -1000; 0 0; 0 0]; % assumed [N]
	nodeElement = [1 2; 2 3; 3 4; 4 5; 2 5; 2 4];
