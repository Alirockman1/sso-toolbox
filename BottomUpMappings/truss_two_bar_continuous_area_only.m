function performanceMeasure = truss_two_bar_continuous_area_only(designSample,systemParameter)
    ...
    %   limitations under the License.
        ...
        youngsModulus1 = systemParameter(3);
        youngsModulus2 = systemParameter(4);
        nInterpolationPoints = systemParameter(5);
    
        interpolationMethod = 'pchip';
    
        nSample = size(designSample,1);
        nDivisions = size(designSample,2)/2;
        ...
        for i=1:nSample
            area1Base = designSample(i,1:nDivisions);
            area2Base = designSample(i,nDivisions+1:2*nDivisions);
            ...
            stiffness1 = 1/trapz(length1Fine,1./(youngsModulus1.*area1Fine));
            stiffness2 = 1/trapz(length2Fine,1./(youngsModulus2.*area2Fine));
