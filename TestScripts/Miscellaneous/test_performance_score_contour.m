...
deficit = design_measure_to_deficit([quantityOfInterest1Grid(:),quantityOfInterest2Grid(:)],quantityOfInterestLowerLimit,quantityOfInterestUpperLimit);
[~,performanceScore] = design_deficit_to_label_score(deficit);
