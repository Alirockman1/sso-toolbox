...
% Material properties arrays (Young's modulus in Pa, density in kg/m^3)
youngsModulusMaterial = [200e9, 70e9, 116e9, 45e9]; % Steel, Aluminum, Titanium, Magnesium
densityMaterial = [7850, 2700, 4500, 1740];        % Steel, Aluminum, Titanium, Magnesium
...
if(computeDisplacement)
    ...
    compute_truss_solution_spaces('Displacement',designEvaluatorDisplacement,initialDesign,designSpaceLowerBound,designSpaceUpperBound,...
        componentIndex,nSample,maxIterDisplacement,growthRateDisplacement,trimmingPasses,...
