...
%     'CandidateSpaceOptions',{'NormalizeGrowthDirection',true,'DoQuickExpansion',true,'DoQuickUpdate',true,'MeasureEstimationFactor',2},...
...
optionsCornerBox = sso_stochastic_options('component',...
    ...
    'CandidateSpaceOptions',{'NormalizeGrowthDirection',true,'CheckRedundantTrimming',false,'CheckDuplicatePoints',false,'MeasureEstimationFactor',2},...
