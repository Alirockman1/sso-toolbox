...
figure; 
hold on;
handleNumericalOptimal = plot([0,bottomUpMapping.BaseVariablesStencils{1},initialDistanceWidth],[initialDistanceHeight,designOptimal,0]','bo-','linewidth',1);
...
[planarTrimmingSolutionSpace,optimizationDataPlanarTrimming] = sso_component_stochastic(designEvaluator,...
    designOptimal,discreteLowerBound,discreteUpperBound,discreteComponentIndex,options);
