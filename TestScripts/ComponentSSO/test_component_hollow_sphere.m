...
options = sso_stochastic_options('component',...
    ...
    'MaxIterExploration',15,...
    'MaxIterConsolidation',15,...
    'TrimmingOperationFunction',@component_trimming_operation_policy,...
    'CandidateSpaceConstructorExploration',@CandidateSpaceCornerBoxRemoval,...
    ...'TrimmingOperationFunction',@component_trimming_operation,...
