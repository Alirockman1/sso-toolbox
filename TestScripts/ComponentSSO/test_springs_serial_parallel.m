...
[componentSolutionSpacePlanar,problemDataPlanar,iterDataPlanar] = sso_component_stochastic(designEvaluator,...
...
optionsCornerBox = sso_stochastic_options('component',...
    ...
    'TrimmingOperationOptions',{'PassesCriterion','full'},...
    'TrimmingOrderOptions',{'OrderPreference','score'});
[componentSolutionSpaceCornerBox,problemDataCornerBox,iterDataCornerBox] = sso_component_stochastic(designEvaluator,...
...
mkdir(resultsFolder);
algoDataPlanar = postprocess_sso_component_stochastic(problemDataPlanar,iterDataPlanar);
...
mkdir(resultsFolder);
algoDataCornerBox = postprocess_sso_component_stochastic(problemDataCornerBox,iterDataCornerBox);
