...
nodePositionOptimalDisplacement = [];
if(findOptimalTruss && computeDisplacement)
    warning('off');
...
nodePositionOptimalMass = [];
if(findOptimalTruss && computeMass)
    warning('off');
...
nodePositionOptimalDisplacementAndMass = [];
if(findOptimalTruss && computeDisplacementAndMass)
    warning('off');
    [nodePositionOptimalDisplacementAndMass,scoreDisplacementAndMassOptimal] = design_optimize_performance_score(...
...
function [solutionSpaceBox,componentSolutionSpacePlanarTrimming,componentSolutionSpaceCornerBoxRemoval,componentSolutionSpaceHolePunching] = ...
    ...
    optionsBox = sso_stochastic_options('box',...
        ...
        ...'TrimmingOrderOptions',{'Order','random'});
    ...
    if(computePlanarTrimmingComponent)
        ...
        optionsComponent = sso_stochastic_options('component',...
            ...
            ...'GrowthAdaptationFactorFunction',@growth_rate_adaptation_linear,...
            ...'TrimmingOrderOptions',{'Order','random'},...
            ...'TrimmingCostOptions',{'SelectionCriteria',{'NumberInsideViable','NumberInsideExclude'}},...
            ...'TrimmingComponentChoiceOptions',{'SelectionCriteria',{'NumberInsideViable','NumberInsideExclude'}},...
            ...'TrimmingOptimalChoiceOptions',{'SelectionCriteria',{'NumberInsideViable'}});
